...
#         'Percentage': [90, 81, 70, 50, 44, 44, 33, 22, 22, 22]}
# var = pd.DataFrame(Wins)
# st.title("Team Winning Percentages Visualization")
# chart_type = st.sidebar.radio("Select Chart Type", ["Matplotlib"])
# st.write("DataFrame:")
# # st.write(var)
# if chart_type == "Matplotlib":
#     st.write("Matplotlib Bar Chart:")
#     fig, ax = plt.subplots()
#     ax.bar(var['Teams'], var['Percentage'])
#     st.pyplot(fig)
...
# ax.set_xlabel('Teams')
# ax.set_title('Team Winning Percentages')
# st.pyplot(fig)
